            ...
            if (finalScore == null) {
                try {
                    ...
                    if (aiVerify != null) {
                        ...
                        throw Exception("Не удалось выполнить ИИ-оценку достоверности. Пожалуйста, попробуйте еще раз.")
                    }
                } catch (e: Exception) {
                    AppLogger.e(TAG, "AI Verification failed", e)
                    throw Exception("Ошибка ИИ-оценки: ${e.message ?: "неизвестная ошибка"}")
                }
            }

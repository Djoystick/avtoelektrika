...
class DiagnosisRepository @Inject constructor(
    ...
    suspend fun getPopularDiagnoses(limit: Int = 10): List<DiagnosisEntity> = dao.getPopularDiagnoses(limit)

    suspend fun getRecentDiagnoses(limit: Int = 10): List<DiagnosisEntity> = dao.getRecentDiagnoses(limit)

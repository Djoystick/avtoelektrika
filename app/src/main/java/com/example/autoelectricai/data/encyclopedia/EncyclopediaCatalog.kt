    ...
    private val brandsFlat: List<EncBrand> = listOf(
        ...
        EncBrand(
            ...
            platforms = listOf(
                ...
                EncPlatform("pq35", "Платформа PQ35 (Golf 5/6, Passat B6/B7)", "📂", 2000, 2025, listOf(
                ...
                EncPlatform("mqb", "Платформа MQB (Golf 7/8, Tiguan 2)", "📂", 2000, 2025, listOf(
        ...
        EncBrand(
            ...
            platforms = listOf(
                ...
                EncPlatform("hybrid", "Hybrid Synergy Drive", "📂", 2000, 2025, listOf(
        ...
        EncBrand(
            ...
            platforms = listOf(
                ...
                EncPlatform("c1", "Платформа C1 / C2 (Focus 2, C-Max)", "📂", 2000, 2025, listOf(
                ...
                EncPlatform("c2_fwd", "Платформа C2 / FWD (Focus 3, Mondeo 5)", "📂", 2000, 2025, listOf(
                ...
                EncPlatform("ev", "Ford EV / Hybrid", "📂", 2000, 2025, listOf(
        ...
        EncBrand(
            ...
            platforms = listOf(
                ...
                EncPlatform("mlb", "Платформа MLB / MLB Evo", "📂", 2000, 2025, listOf(
                ...
                EncPlatform("mmi", "MMI / Виртуальный кокпит", "📂", 2000, 2025, listOf(
        ...
        EncBrand(
            ...
            platforms = listOf(
                ...
                EncPlatform("delta", "Платформа Delta (Cruze)", "📂", 2000, 2025, listOf(
                ...
                EncPlatform("gamma", "Платформа Gamma (Spark, Sonic)", "📂", 2000, 2025, listOf(
                ...
                EncPlatform("gmt", "GMT (Silverado, Tahoe)", "📂", 2000, 2025, listOf(
                ...
                EncPlatform("ev", "EV / Hybrid (Bolt, Volt)", "📂", 2000, 2025, listOf(
        ...
        EncBrand(
            ...
            platforms = listOf(
                ...
                EncPlatform("outlander", "Outlander / ASX", "📂", 2000, 2025, listOf(
                ...
                EncPlatform("lancer", "Lancer / Evolution", "📂", 2000, 2025, listOf(
                ...
                EncPlatform("l200", "L200 / Pajero", "📂", 2000, 2025, listOf(
                ...
                EncPlatform("phev", "Outlander PHEV", "📂", 2000, 2025, listOf(
        ...
        EncBrand(
            ...
            platforms = listOf(
                ...
                EncPlatform("civic", "Civic / Accord / CR-V", "📂", 2000, 2025, listOf(
                ...
                EncPlatform("fit", "Fit / Jazz", "📂", 2000, 2025, listOf(
                    EncSystem("wiring", "Упрощённая архитектура", "⚡", listOf("Особенности")),
        ...
        EncCountry("usa", "США", "🇺🇸", brandsFlat.filter { it.id in listOf("ford", "chevrolet", "jeep", "dodge", "chrysler", "cadillac", "tesla") }),
